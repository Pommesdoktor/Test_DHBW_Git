========================================================================
    KONSOLENANWENDUNG: Test_DHBW-Projektübersicht
========================================================================

Diese Test_DHBW-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Test_DHBW-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Test_DHBW.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
